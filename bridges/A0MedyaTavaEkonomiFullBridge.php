...
class A0MedyaTavaEkonomiFullBridge extends BridgeAbstract {
    const NAME = 'Medya Tava Ekonomi Full Bridge';
            ...
            if ($item['uri']) {
                ...
                if ($linkedPage) {
                    ...
                    if ($contentDetail) {
                        ...
                        foreach ($contentDetail->find('h1, nav, a.google-news_wrapper, figure, div.info, div.sharing, div[class^="adpro"], aside, div[class^="col-6"]') as $unwanted) {
